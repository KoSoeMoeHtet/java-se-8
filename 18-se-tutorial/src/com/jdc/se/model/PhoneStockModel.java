...
public class PhoneStockModel extends CommonModel<Phone_stock> implements StockModel<Phone_stock>{
	...
	public void addStock(Map<String, Object> param) throws SQLException {
		// get old
		Phone_stock oldRec = getLastStock((Integer) param.get("phone_id"));
	...
	private Phone_stock getLastStock(Integer id) throws SQLException {
		Map<String, Object> param = new LinkedHashMap<>();
		param.put("phone_id", id);
		param.put("status", new Integer(1));
		List<Phone_stock> list = this.getWhere(param);
		for (Phone_stock s : list) {
			return s;
		}
		return null;
	}
	...
	private Map<String, Object> getCancelParam(Phone_stock oldRec) throws IllegalArgumentException, IllegalAccessException {
