...
public class EmployeeCallback implements Callback<TableColumn<Balance,String>, TableCell<Balance,String>>{
	...
	public TableCell<Balance, String> call(TableColumn<Balance, String> param) {
		return new TableCell<Balance, String>() {
			protected void updateItem(String item, boolean empty) {
				...
				if(null != b && b.getEmployee() != null) {
					setText(b.getEmployee().getName());
				} else {
					setText(null);
				}
			}
